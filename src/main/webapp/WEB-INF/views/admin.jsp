...
<form:form method="post" modelAttribute="challenge" style="margin-top: 75px;">
<div align="center">
	...
	<button type="submit" class="btn btn-primary" style="margin-top: 75px;">ADD NEW CHALLENGE</button>
	<font color="red"><b><h1>${error}</h1></b></font>
	</div>
</form:form>



<table class="table table-striped table-dark" style="margin-top: 65px;">
  <thead>
    <tr>
      <th scope="col">Id</th>
