...
<body style="background-image: url(<c:url value="static/img/runner.jpeg"/>)">
...
<div class="question"><h1 style="margin-top: 150px;" align="center"> Check how fast you should run to make your dreams come true!</h1></div></br>
<div align="center"> <a href="<c:url value="/calculator"/>"><button type="button" class="btn btn-primary">Go to running calculator</button></a></div> 
